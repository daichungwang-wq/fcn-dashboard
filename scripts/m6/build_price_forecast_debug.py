...
def build_model_points(symbol: str, today: float, m1: Dict[str, Any], m7: Dict[str, Any]) -> List[Dict[str, Any]]:
    """
    Collect six model prices:
      M1 linear / quadratic / log
      M7 linear / quadratic / log

    Field names are intentionally broad because current data schemas are still evolving.
    """
    ...
    best_r2 = r2_from_fields(m7, ["best_structure_r2", "structure_r2", "regression_r2"], 0.50)
    ...
    specs = [
        {
            ...
            "model": "linear",
            "label": "m1-L",
            "price": price_from_fields(m1, [
                "m1_linear_fair_price",
                "linear_fair_price",
                "regression_fair_price_linear",
                "fair_price_linear",
            ]),
            "r2": r2_from_fields(m1, ["m1_linear_r2", "linear_r2", "regression_r2_linear"], best_r2),
        },
        {
            "module": "M1",
            "model": "quadratic",
            "label": "m1-Q",
            "price": price_from_fields(m1, [
                "m1_quadratic_fair_price",
                "quadratic_fair_price",
                "regression_fair_price_quadratic",
                "fair_price_quadratic",
            ]),
            "r2": r2_from_fields(m1, ["m1_quadratic_r2", "quadratic_r2", "regression_r2_quadratic"], best_r2),
        },
        {
            "module": "M1",
            "model": "log",
            ...
            "price": price_from_fields(m1, [
                "m1_log_fair_price",
                "m1_logarithmic_fair_price",
                "log_fair_price",
                "logarithmic_fair_price",
                "regression_fair_price_log",
                "fair_price_log",
            ]),
            "r2": r2_from_fields(m1, ["m1_log_r2", "log_r2", "logarithmic_r2", "regression_r2_logarithmic"], best_r2),
        },
        {
            "module": "M7",
            "model": "linear",
            "label": "m7-L",
            "price": price_from_fields(m7, [
                "m7_linear_fair_price",
                "linear_fair_price",
                "regression_fair_price_linear",
                "fair_price_linear",
                "regression_linear_fair_price",
            ]),
            "r2": r2_from_fields(m7, ["structure_r2_linear", "regression_r2_linear", "linear_r2"], best_r2),
        },
        {
            "module": "M7",
            "model": "quadratic",
            "label": "m7-Q",
            "price": price_from_fields(m7, [
                "m7_quadratic_fair_price",
                "quadratic_fair_price",
                "regression_fair_price_quadratic",
                "fair_price_quadratic",
                "regression_quadratic_fair_price",
                "regression_fair_price_now",
                "fair_price",
                "fair_value",
            ]),
            "r2": r2_from_fields(m7, ["structure_r2_quadratic", "regression_r2_quadratic", "quadratic_r2"], best_r2),
        },
        {
            "module": "M7",
            "model": "log",
            ...
            "price": price_from_fields(m7, [
                "m7_log_fair_price",
                "m7_logarithmic_fair_price",
                "log_fair_price",
                "logarithmic_fair_price",
                "regression_fair_price_log",
                "fair_price_log",
                "regression_logarithmic_fair_price",
            ]),
            "r2": r2_from_fields(m7, ["structure_r2_logarithmic", "regression_r2_logarithmic", "log_r2", "logarithmic_r2"], best_r2),
        },
    ]
...
def main() -> None:
    ...
    if DEBUG_MODE:
        symbols = sorted(s for s in DEBUG_SYMBOLS if s in all_symbols)
    ...
    payload = {
        ...
        "formula": {
            ...
            "result_b_fair_return": "sum(((fair_price_i - today_price) / today_price) * confidence_weight_i) / sum(confidence_weight_i)",
